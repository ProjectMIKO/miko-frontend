  ...
  return (
    <div className="flex flex-col items-center h-screen overflow-hidden">
      ...
      <div className="relative w-full h-full">
        ...
        <div
          className={`absolute right-0 top-16 z-20 bg-[rgba(249,249,249,0.7)] backdrop-blur-sm border border-gray-300 rounded-lg shadow-lg transition-transform duration-300 ${
